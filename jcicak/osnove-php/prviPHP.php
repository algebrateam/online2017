...
<html>
    ...
    <body>
        ...
        <h3>PHP zbroj</h3>
        <div style="color: deepskyblue">  <?php
            /*
             * To change this license header, choose License Headers in Project Properties.
             * To change this template file, choose Tools | Templates
             * and open the template in the editor.
            ...
            echo "uskrs pada " . easter_days(2018) . " nakon 21.03.<br>";
...
# $12greška; // ne možemo nazvati varijablu brojem
# linijski
// linijski
            /*
             * 
             ...
             * */
            /**
             *  ovo je rezevrirano za dokumentaciju
             * */
            $a = 5;
            $b = 7;
            $c = $a + $b;
